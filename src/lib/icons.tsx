...
import {
  ...
  faCalendar, faCalendarDay, faCalendarDays, faCalendarWeek,
  ...
  faClock, faCompactDisc, faCompress, faCopy, faCreditCard, faCrown,
  ...
  faImage, faInbox,
  faKey, faKeyboard,
  faLayerGroup, faLink, faList, faLock,
  ...
  faSpinner, faSquare as faSquareSolid, faSquareCheck, faStopwatch,
  faTable, faTableCellsLarge, faTableColumns, faTableList, faTag, faThumbtack, faTicket,
  faTrash, faTriangleExclamation,
  faUpload, faUser, faUserCheck, faUserMinus, faUserPlus, faUsers,
