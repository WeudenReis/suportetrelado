...
var DndMonitorContext = (0, import_react3.createContext)({
  type: null,
  event: null
});
function useDndMonitor({
  ...
  const monitorState = (0, import_react3.useContext)(DndMonitorContext);
  const previousMonitorState = (0, import_react3.useRef)(monitorState);
...
function Accessibility({
  ...
  return mounted ? (0, import_react_dom.createPortal)(import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement(HiddenText, {
...
function useAutoScroller({
  ...
  const scrollDirection = (0, import_react3.useRef)(defaultCoordinates);
...
function useDroppableMeasuring(containers, {
  ...
  const [containerIdsScheduledForMeasurement, setContainerIdsScheduledForMeasurement] = (0, import_react3.useState)(null);
  ...
  const measureDroppableContainers = (0, import_react3.useCallback)((ids2 = []) => setContainerIdsScheduledForMeasurement((value) => value ? value.concat(ids2) : ids2), []);
...
function useRect(element, getRect, forceRecompute) {
  const previousElement = (0, import_react3.useRef)(element);
...
function createUseRectsFn(getRect) {
  ...
  return function useRects(elements, forceRecompute) {
    const previousElements = (0, import_react3.useRef)(elements);
    return useLazyMemo((previousValue) => {
      if (!elements.length) {
...
var DndContext = (0, import_react3.memo)(function DndContext2({
  id,
  autoScroll = true,
  announcements,
  children,
  ...
  const [monitorState, setMonitorState] = (0, import_react3.useState)(() => ({
    type: null,
    event: null
  }));
  ...
  const initialActiveNodeRectRef = (0, import_react3.useRef)(null);
  ...
  return import_react3.default.createElement(DndMonitorContext.Provider, {
    ...
    value: transform
  }, children))), import_react3.default.createElement(Accessibility, {
    announcements,
...
function useDropAnimation({
  ...
  const [dropAnimationComplete, setDropAnimationComplete] = (0, import_react3.useState)(false);
  useIsomorphicLayoutEffect(() => {
...
var DragOverlay = import_react3.default.memo(({
  ...
  const attributesSnapshot = (0, import_react3.useRef)(attributes);
  ...
  const prevActiveId = (0, import_react3.useRef)((_active$id = active == null ? void 0 : active.id) != null ? _active$id : null);
  ...
  }, import_react3.default.createElement(wrapperElement, {
    ...otherAttributes,
...
//# sourceMappingURL=chunk-4DJOOBDE.js.map
